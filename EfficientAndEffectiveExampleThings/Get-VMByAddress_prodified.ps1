...
Process {
    Switch ($PsCmdlet.ParameterSetName) {
        "FindByMac" {
            ...
            Get-View -Viewtype VirtualMachine -Property Name, Config.Hardware.Device | Where-Object {$_.Config.Hardware.Device | Where-Object {($_ -is [VMware.Vim.VirtualEthernetCard]) -and ($MAC -contains $_.MacAddress)}} | Select-Object @{n = "VMName"; e = {$_.Name}}, @{n = "MacAddress"; e = {($_.Config.Hardware.Device | Where-Object {$_ -is [VMware.Vim.VirtualEthernetCard]} | ForEach-Object {$_.MacAddress} | Sort-Object) -join ","}}, MoRef
            break;
        } ## end case
        {"FindByIp", "FindByIPWildcard" -contains $_} {
            ...
            $sblkFindByIP_WhereStatement = if ($PsCmdlet.ParameterSetName -eq "FindByIPWildcard") {
                {$_.IpAddress | Where-Object {$_ -like $AddressWildcard}}
            }
            else {
                {$_.IpAddress -contains $IP}
            }
            ## return the .Net View object(s) for the VM(s) with the NIC(s) w/ the given IP
            Get-View -Viewtype VirtualMachine -Property Name, Guest.Net | Where-Object {$_.Guest.Net | Where-Object $sblkFindByIP_WhereStatement} | Select-Object @{n = "VMName"; e = {$_.Name}}, @{n = "IP"; e = {($_.Guest.Net | ForEach-Object {$_.IpAddress} | Sort-Object) -join ","}}, MoRef
        } ## end case
    } ## end switch
} ## end process